...
def arg_parser():
    ...
    parser.add_argument("-t", "--redirectto", help="Optional argument to choose the IP \
                                                   to which the victim will be redirected \
                                                   otherwise defaults to attacker's local IP. \
                                                   Requires either the -d or -a argument. \
                                                   Example: -t 80.87.128.67")
    parser.add_argument("-a", "--spoofall", help="Spoof all DNS requests back to the attacker \
                                                 or use -r to specify an IP to redirect them to", \
                                                 action="store_true")
